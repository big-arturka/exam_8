    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('github', models.CharField(blank=True, max_length=100, null=True, verbose_name='Ссылка на GitHub')),
                ('vita', models.TextField(blank=True, null=True, verbose_name='О себе')),
